...
public class CliTest {
    ...
    // This test was checking the system log outputs for features that aren't there.
    // @Test
    ...
    // "org.opencds.cqf.cql.engine.exception.CqlException: Translation of library
    // FluentFunctions failed with the following message: Feature Fluent functions
    // was introduced in version 1.5 and so cannot be used at compatibility level
    // 1.4"));
    // }
    ...
    // "SDE Ethnicity=[Code { code: 2184-0, system: urn:oid:2.16.840.1.113883.6.238,
    // version: null, display: Dominican }, Code { code: 2148-5, system:
    // urn:oid:2.16.840.1.113883.6.238, version: null, display: Mexican }]"));
    // assertTrue(output.contains(
    // "SDE Race=[Code { code: 1586-7, system: urn:oid:2.16.840.1.113883.6.238,
    // version: null, display: Shoshone }, Code { code: 2036-2, system:
    // urn:oid:2.16.840.1.113883.6.238, version: null, display: Filipino }, Code {
    // code: 1735-0, system: urn:oid:2.16.840.1.113883.6.238, version: null,
    // display: Alaska Native }]"));
    // assertTrue(output.contains("SDE Payer=[Tuple {\n" +
    // "\t\"code\": Concept {\n" +
    // "\tCode { code: 59, system: urn:oid:2.16.840.1.113883.3.221.5, version: null,
    ...
    // "}]"));
    // assertTrue(output.contains(
    // "SDE Sex=Code { code: M, system: http://hl7.org/fhir/v3/AdministrativeGender,
    // version: null, display: Male }"));
    ...
    // assertTrue(output.contains(
    // "SDE Sex=Code { code: F, system: http://hl7.org/fhir/v3/AdministrativeGender,
    // version: null, display: Female }"));
